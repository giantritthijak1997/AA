<?php
    ...
    $category = $_GET['cat'];
	$sql = "SELECT * FROM files WHERE status = 1 AND file_type_id =".$category;
              ...
              <nav>
                <ul class="nav topnav">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="Page1.php">มาตรฐานการรายงานทางการเงิน</a></li>
                        <li><a href="Page2.php">มาตรฐานการสอบบัญชี</a></li>
                        <li><a href="Page3.html">มาตรฐานการควบคุมคุณภาพ</a></li>
                        <li class="dropdown"><a href="Page4.html">มาตรฐานการศึกษา <i class="icon-angle-right"></i></a>
        ...
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2>มาตรฐานการรายงานทางการเงิน</h2>
            </div>
          </div>
